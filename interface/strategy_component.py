...
class StrategyEditor(tk.Frame):
    def __init__(self, root: "Root", binance: BinanceClient, *args, **kwargs):
        ...
        self._base_params = [
            ...
            {"code_name": "balance_pct", "widget": tk.Entry, "data_type": float, "width": 8, "header": "Balance %"},
            {"code_name": "take_profit", "widget": tk.Entry, "data_type": float, "width": 8, "header": "TP %"},
            {"code_name": "stop_loss", "widget": tk.Entry, "data_type": float, "width": 8, "header": "SL %"},
            {"code_name": "parameters", "widget": tk.Button, "data_type": float, "text": "Parameters",
             "bg": BG_COLOR_2, "command": self._show_popup, "header": "", "width": 65},
        ...
        for col, base_param in enumerate(self._base_params):
            ...
            if base_param['widget'] == tk.OptionMenu:
                ...
                self.body_widgets[code_name][b_index] = tk.OptionMenu(self._body_frame.sub_frame,
                                                                      ...
                                                                      *base_param['values'])
                self.body_widgets[code_name][b_index].config(width=base_param['width'], bd=-1, highlightthickness=False,
                                                             indicatoron=0)
                ...
                self.body_widgets[code_name][b_index] = tkmac.Button(self._body_frame.sub_frame,
